            ...
            <form method="POST" action="{{ route('pacientes.store') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" class="form-input w-full" id="name" name="nombre" value="{{ old('nombre') }}" required>
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    ...
                    <div>
                        ...
                        <input type="text" class="form-input w-full" id="nss" name="nss" value="{{ old('nss') }}" required>
                    </div>
                </div>
